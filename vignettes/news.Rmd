...
#### 4.2-5 Tuning and Modeling options

##### Bugfix
- fixed calculations of the number of models in `BIOMOD_Modeling` when using `models.pa`

##### Internal 
- removed commented code on `MAXENT.Tsuruoka`.

#### 4.2-4 Xgboost and Tuning

##### Major Changes
- Added `XGBOOST` as a new possible model.

#### 4.2-3 Cross-Validation and Pseudo-Absences (2023-04-04)
...
#### 4.1-2 (2022-09-29 - Current CRAN Version)
