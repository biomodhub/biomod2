...
- 4.3-2-1 : 
  + change the name of the metric `ROC` to `AUC_ROC`. It will switch automatically if you use `ROC`.
  + add the metric `AUC_PRG` : Area Under Curve of the Precision-Recall-Gain curve. 
