...
* `BIOMOD_EnsembleModeling` now have an argument `em.algo` to select the ensemble 
algorithm to be computed. Separate arguments are now deprecated (prob.mean, 
prob.median, prob.cv, prob.ci, committee.averaging, prob.mean.weight)
