...
#### 4.2-3 Release 2023.2 (2023-01-18)
...
* Fixed `BIOMOD_Projection` for large (or numerous) raster for which `terraOption(todisk = TRUE)` is automatically activated.
* Fixed Ensemble Models based on models without cross-validation ("AllRun")

##### Miscellaneous
* improved documentation for `get_evaluations()`
