...
* Using models with a single predictor requires updating `gbm` and `maxnet` packages to their development version at rpatin/maxnet and rpatin/gbm can be used. (see issue *<https://github.com/biomodhub/biomod2/issues/102>*)
