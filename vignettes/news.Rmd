...
- Warning ! New options for OptionsBigboss have been modified ( concern only ANN, CTA and RF models)
- Some changes for the tuning ranges.
- Add *RFd*: Random Forest with down-sampling method.
- Add _seed.val_ for bm_pseudoAbsences and BIOMOD_FormatingData.
- Add  _fact.aggr_ argument for pseudoabsences selection with the random and disk method. It allows to reduce the resolution of the environnement.
