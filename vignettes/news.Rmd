...
#### 4.2-6-1 Devel actuel 

- Correction : Some paths failed depending on the name of the species (e.g.: name of data format (as "tif") in the species name)
...
- Add  _fact.aggr_ argument for pseudo-absences selection with the random and disk methods. It allows to reduce the resolution of the environment.
