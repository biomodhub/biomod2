...
<embed src="pictures/biomod2_presentation.workflow_01_2026.pdf" width="900" height="700" type="application/pdf" allowfullscreen webkitallowfullscreen>
</embed>
</div>
...
<p><a href="https://biomodhub.github.io/biomod2/articles/pictures/biomod2_presentation.workflow_01_2026.pdf">Download pdf of PRESENTATION <i class="fas fa-download"></i></a></p>
</div>
...
- Explore basic statistical assumptions like residuals' outliers, normality and heteroscedasticity (*through [bm_ModelAnalysis](../reference/bm_ModelAnalysis.html)*)
...
#### <i class="fa-solid fa-earth-europe"></i> Projecting models : [BIOMOD_Projection](../reference/BIOMOD_Projection.html), [BIOMOD_EnsembleForecasting](../reference/BIOMOD_EnsembleForecasting.html)
...
#### <i class="fa-solid fa-file-export"></i> Report : [BIOMOD_Report](../reference/BIOMOD_Report.html)

- Get all prints, summaries, biomod2 object outputs and plots
- Extract modelling informations to pre-fill **ODMAP protocol**
- Get command lines used to call main biomod2 functions
