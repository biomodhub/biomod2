...
The [**tidyverse**](https://tidyverse.org/) is a compilation of **R** packages
...
this upper limit can be modified using the `maxcell` argument of the geom
function.
...
<div class="figure">
<img src="./fig-ex1-1.png" alt="Faceted map with multi-layer raster file." width="100%" />
